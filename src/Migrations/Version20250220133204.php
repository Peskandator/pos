 ...
 */
final class Version20250220133204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, dining_table_id INT NOT NULL, company_id INT NOT NULL, description VARCHAR(255) DEFAULT NULL, creation_date DATE NOT NULL, update_date DATE NOT NULL, INDEX IDX_F5299398695B08DC (dining_table_id), INDEX IDX_F5299398979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
